...
| [第 4 章](chapter-04.md) | 雲原生技術棧的選擇與理由 | Docker 容器化最佳實踐、Kubernetes 核心概念、Istio 服務網格、OpenTelemetry 統一遙測、NATS 高性能消息隊列、etcd 分佈式服務發現、開源工具棧總覽、Helm Charts 應用打包、CI/CD Pipeline 基礎 |
...
| 章節 | 標題 | 內容概要 |
|------|------|----------|
| [附錄](chapter-13.md) | 核心術語表 | 本書涉及的技術術語、縮寫與專有名詞，按主題分類（AI Agent 核心概念、平台組件、AI 與大語言模型、通信協議、雲原生基礎設施、服務網格、可觀測性、數據存儲、安全認證、架構模式），每個術語提供英文原名、中文釋義與主要參照章節 |
